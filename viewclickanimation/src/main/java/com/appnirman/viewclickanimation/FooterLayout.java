...
public class FooterLayout extends FrameLayout {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mBackgroundColor = a.getColor(R.styleable.FooterLayout_ft_menu_backgroundColor, Color.TRANSPARENT);
    ...
    private void initBackgroundDimAnimation() {
        ...
        mShowBackgroundAnimator.setDuration(DEFAULT_ANIMATION_DURATION);
        ...
        mHideBackgroundAnimator.setDuration(DEFAULT_ANIMATION_DURATION);
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP) private void expandLollipop() {
        ...
        float dy = ViewUtils.getRelativeTop(mFabExpandLayout)
